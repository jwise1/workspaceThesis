...
def main():
    ...
    st.image("./VV3.jpg",caption="Verse Vault uses machine learning to generate passwords from song lyrics and rank the security of them based on cyberattack prediction", width=500)
